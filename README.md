...
| Tests | 211 Playwright regressions against real Chromium + 7 vitest units, all gated in CI |
...
- **211 Playwright regressions** drive the real game in a real browser — they call `startGame()`,
...
| `tests/` | 211 Playwright regressions |
